...
- **Single Post Modal** — two-step flow (topic → review) with tier-specific behavior:
  - Starter: Facebook-only, 2/day AI limit, save as draft only, copy-paste workflow
  - Grow: Facebook + Instagram, 2/day AI limit, image upload (data URL), save as draft or schedule
  - Pro/Elite: unlimited AI, image upload, save as draft or schedule
  - Updated AI prompt (short, friendly, 280 chars, 1-2 hashtags), tier-based max_tokens (300/400)
- **AI Rate Limit Badge** — "AI posts: n/2 used today" shown for Starter/Grow tiers, refreshes after each save
- **Campaigns Tab — Pro 5-day cap** — Starter/Grow see locked card with upgrade CTA; Pro validated to max 5 days on submit; helper text updated
- **Analytics Tab — tier-gated content** — Starter/Grow see BarChart3 icon + locked placeholder; Pro sees 2×2 grid (Published, Likes, Impressions, Platforms Active) with "Basic Analytics" label; Elite unchanged
