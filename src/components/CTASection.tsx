...
const CTASection = () => {
  return (
    ...
    >
      <div className="relative z-10 px-4" style={{ paddingTop: '48px', paddingBottom: '32px' }}>
        <div className="container mx-auto">
          <h2
            className="text-comic uppercase mb-4"
            style={{
              color: 'hsl(48, 100%, 50%)',
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:9038710550"
              className="inline-flex items-center gap-2 font-bold rounded-full px-7 py-3 text-sm border-2 border-white text-white transition-all hover:bg-white hover:text-orange-500"
            >
              <Phone className="w-5 h-5" /> (903) 871-0550
            </a>
            <Link
              to="/quote"
              className="inline-flex items-center justify-center font-bold rounded-full px-8 py-3 text-sm transition-all"
              style={{
                background: 'white',
                color: 'hsl(28, 100%, 50%)',
