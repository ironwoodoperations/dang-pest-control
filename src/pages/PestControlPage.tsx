...
const steps = [
  {
    num: 'STEP 1',
    title: 'Phone Quoting Made Easy',
    desc: 'No inspection is required to get started. Our team will assess your needs by gathering essential details about your property—size, pest issues, and more—over the phone. Using this information, we\'ll prepare a plan before even stepping onto your property.',
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Control-Process-img1.png',
  },
  {
    num: 'STEP 2',
    title: 'Thorough Initial Service',
    desc: '',
    extraContent: true,
  ...
  },
  {
    ...
    desc: "Based on our findings, we'll discuss a detailed solution tailored to your situation. Our integrated pest management approach doesn't just treat pests temporarily—it gets to the root of the problem to keep them away year-round.",
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Control-Process-img3.png',
  },
  {
    num: 'STEP 4',
    title: 'Monitoring & Preventative Care',
    desc: 'To ensure long-lasting protection, our team monitors your property regularly, adjusting treatments as needed to guarantee effectiveness.',
...
const whyCards = [
  {
    ...
    desc: 'We are proud members of the National Pest Management Association (NPMA) and the Texas Pest Control Association (TPCA), reflecting our commitment to industry best practices and professionalism.',
  },
  {
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Comprehensive.png',
    title: 'Environmentally Responsible',
    desc: "Our Integrated Pest Management (IPM) approach prioritizes environmentally protective solutions. We don't just spray for a quick fix—we work to eliminate the root causes of your pest problems.",
  },
  {
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Safety.png',
    title: 'Proven Results',
    desc: "Our technicians leverage years of experience to deliver effective pest control with minimal disruption to your daily life. Whether it's ants, spiders, cockroaches, or more unique pests, we've got the skills to handle the job.",
  },
  {
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Guarantee.png',
    title: 'Customer-Focused Service',
    desc: "From the moment you call until the final treatment, we're dedicated to your satisfaction. Our knowledgeable team will walk you through each step of the process, ensuring your property is pest-free.",
  },
  {
    icon: 'https://www.dangpestcontrol.com/wp-content/uploads/2025/03/Custom-Plans.png',
    title: 'Local & Reliable',
    desc: 'Based in Tyler, TX, Dang Pest Control proudly serves homeowners and property managers across Longview, Jacksonville, Lindale, Bullard, Whitehouse, and surrounding areas.',
  },
];
...
const PestControlPage = () => {
  ...
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif", color: 'hsl(20, 40%, 12%)', overflowX: 'hidden' }}>
      ...
      <section className="px-4 md:px-10" style={{ paddingTop: '80px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto', background: '#ffffff', backgroundImage: 'radial-gradient(circle, #d0d0d0 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div style={{ border: '4px solid rgb(255, 213, 39)', borderRadius: '6px', overflow: 'hidden', boxShadow: '8px 8px 0 rgba(0,0,0,0.1)' }}>
            <VideoImage
              src="https://www.dangpestcontrol.com/wp-content/uploads/2025/05/Interior-Pantry-Spraying-scaled-e1746211834244.jpg"
              alt="Technician Providing Pest Control Services in Tyler TX"
              className=""
          ...
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(26px, 2.8vw, 38px)', fontWeight: '800', marginBottom: '18px', marginTop: 0 }}>
              Comprehensive General Pest Control Services
            </h2>
            <p style={{ fontSize: '16px', lineHeight: 1.75, marginBottom: '28px', color: '#444', marginTop: 0 }}>
              ...
              we deliver general pest control services tailored to the unique challenges of the East Texas environment. Count on our team of skilled technicians to protect your home from unwanted invaders with precision and professionalism. We serve Tyler, TX, and the surrounding areas. Call us today at{' '}
      ...
      <section className="px-4 md:px-10" style={{ background: '#f1f1ef', paddingTop: '70px', paddingBottom: '70px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', color: '#666', marginBottom: '50px', marginTop: 0 }}>
            Here's what you can expect from our pest control services:
          </p>
      ...
      {/* ══════════════════════════════════════════════════════
          ADDITIONAL SERVICES — text left, dotted image right
      ══════════════════════════════════════════════════════ */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <p style={{ fontSize: '15px', lineHeight: 1.8, marginBottom: '16px', color: '#444', marginTop: 0 }}>
              While our general pest control treatments cover the most common pests in East Texas, we also provide specialized services, including:
            </p>
          ...
          <div style={{ position: 'relative', padding: '20px' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1, border: '4px solid rgb(255, 213, 39)', borderRadius: '6px', overflow: 'hidden', boxShadow: '8px 8px 0 rgba(0,0,0,0.1)' }}>
              <img
                ...
                width={600}
                height={400}
                src="https://www.dangpestcontrol.com/wp-content/uploads/2025/05/Exterior-Fence-scaled-e1746211948229.jpg"
                alt="Exterior General Pest Control Services in Tyler TX"
      ...
      ══════════════════════════════════════════════════════ */}
      <style>{`
        .pest-cta-phone { background: hsl(28,100%,50%) !important; color: #fff !important; border: 2px solid hsl(28,100%,50%) !important; }
        .pest-cta-phone:hover { background: #fff !important; color: hsl(20,40%,12%) !important; }
        .pest-cta-quote { background: #fff !important; color: hsl(28,100%,50%) !important; border: 2px solid #fff !important; }
        .pest-cta-quote:hover { background: hsl(45,95%,52%) !important; color: #fff !important; }
      `}</style>
      <section className="px-4 md:px-10" style={{ position: 'relative', background: 'hsl(28, 100%, 50%)', paddingTop: '100px', paddingBottom: '260px', clipPath: 'polygon(0 0, 100% 8%, 100% 100%, 0 100%)', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: '900px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '16px', lineHeight: 1.8, color: 'rgba(0,0,0,0.72)', marginBottom: '28px', marginTop: 0 }}>
            ...
            <a href="/whitehouse-tx" style={{ color: '#000' }}>Whitehouse</a>.
            Call us today at{' '}
            <a href="tel:(903) 871-0550" style={{ color: '#000', fontWeight: '700' }}>(903) 871-0550</a>{' '}
