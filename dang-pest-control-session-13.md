# Dang Pest Control — Session 13 Context
...
src/components/admin/
  ...
  TeamTab.tsx              ✅
  TestimonialsTab.tsx      ✅
  ReviewsTab.tsx           ✅ Session 12 — LeadFusion Local, Elite gated, live Google reviews, Sync to Testimonials
  seo/
    AIOTab.tsx             ✅
    KeywordResearch.tsx    ✅
...
src/pages/
  AdminLogin.tsx
  AdminPage.tsx            ✅ Reviews tab wired in
...
| Item | Priority | Notes |
|---|---|---|
| **Verify Resend live** | High | Test real form submit, confirm email arrives at info@dangpestcontrol.com |
| **Facebook token** | Low | Social posting is still demo mode — needs real FB token to go live |
| Twilio | ❌ Dropped | PestFlow Pro spec item only |
